...
func (c *orderServiceClient) UpdateOrderStatusByOrderId(ctx context.Context, in *UpdateOrderStatusRequest, opts ...grpc.CallOption) (*UpdateOrderStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, OrderService_UpdateOrderStatusByOrderId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedOrderServiceServer) UpdateOrderById(context.Context, *UpdateOrderRequest) (*OrderResponse1, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateOrderById not implemented")
}
func (UnimplementedOrderServiceServer) DeleteOrderById(context.Context, *DeleteOrderRequest) (*DeleteOrderResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteOrderById not implemented")
}
...
func (UnimplementedOrderServiceServer) UpdateOrderStatusByOrderId(context.Context, *UpdateOrderStatusRequest) (*UpdateOrderStatusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateOrderStatusByOrderId not implemented")
}
